...
public class PreparationExamingDialog extends DialogPane<Boolean> {
	...
	private void refresh(Integer pid) {
		List<SubmitInfo> submits = SpringUtil.getBean(PreparationPublishAction.class).findSubmitStateById(pid);
