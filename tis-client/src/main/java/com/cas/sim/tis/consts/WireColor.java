...
public enum WireColor {
	YELLOW(Color.YELLOW, "elec.case.wires.yellow"), //
	GREEN(Color.GREEN, "elec.case.wires.green"), //
	RED(Color.RED, "elec.case.wires.red"), //
	BLUE(Color.BLUE, "elec.case.wires.blue"), //
	BLACK(Color.BLACK, "elec.case.wires.black")//
	;
