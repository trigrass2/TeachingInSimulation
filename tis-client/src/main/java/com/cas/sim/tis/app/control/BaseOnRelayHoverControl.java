...
public class BaseOnRelayHoverControl extends AbstractControl {
	...
	private Camera cam;
	private Consumer<ElecCompDef> consumer;

	public BaseOnRelayHoverControl(Consumer<ElecCompDef> consumer, InputManager inputManager, Camera cam) {
	...
	protected void controlUpdate(float tpf) {
		...
		if (results.size() > 0) {
			...
			consumer.accept(spatial.getUserData("entity"));
		}
	}
