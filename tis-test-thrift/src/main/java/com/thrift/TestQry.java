/**
 * Autogenerated by Thrift Compiler (0.11.0) DO NOT EDIT UNLESS YOU ARE SURE THAT YOU KNOW WHAT YOU ARE DOING
 * @generated
 */
package com.thrift;
...
public class TestQry {
	...
	public static class qryTest_args implements org.apache.thrift.TBase<qryTest_args, qryTest_args._Fields>, java.io.Serializable, Cloneable, Comparable<qryTest_args> {
		...
		static {
			...
			tmpMap.put(_Fields.QRY_CODE, new org.apache.thrift.meta_data.FieldMetaData("qryCode", org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
		...
		public qryTest_args(int qryCode) {
			this();
			this.qryCode = qryCode;
		...
		public boolean equals(java.lang.Object that) {
			...
			if (that instanceof qryTest_args) return this.equals((qryTest_args) that);
			return false;
		}
		...
		public boolean equals(qryTest_args that) {
			...
			if (this_present_qryCode || that_present_qryCode) {
				if (!(this_present_qryCode && that_present_qryCode)) return false;
				if (this.qryCode != that.qryCode) return false;
			}
	...
	public static class qryTest_result implements org.apache.thrift.TBase<qryTest_result, qryTest_result._Fields>, java.io.Serializable, Cloneable, Comparable<qryTest_result> {
		...
		static {
			java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new java.util.EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
			tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, QryResult.class)));
			metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
		...
		public qryTest_result(QryResult success) {
			this();
		...
		public boolean equals(java.lang.Object that) {
			if (that == null) return false;
			if (that instanceof qryTest_result) return this.equals((qryTest_result) that);
			return false;
		}
