...
CREATE TABLE `examination` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='考试记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `examination_answer` (
  ...
  `CREATOR_ID` int(11) DEFAULT NULL COMMENT '创建人',
  `CLS_ID` int(11) DEFAULT NULL COMMENT '班级ID（脏数据，为了提高查询效率）',
  `DEL` tinyint(1) DEFAULT NULL,
  `SCORE` float DEFAULT NULL COMMENT '本次考试成绩',
  `EXAM_TIME` varchar(45) DEFAULT NULL COMMENT '考试开始时间',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='考试答题';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-01-15 20:12:30
